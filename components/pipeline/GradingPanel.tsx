  ...
  return (
    <div className="flex h-full flex-col">
      <div className="mb-2 flex items-center justify-between gap-3">
        ...
        <span className={`rounded-full px-3 py-1 text-sm ${reviewStatus === "teacher_modified" ? "bg-amber-50 text-amber-700" : "bg-emerald-50 text-emerald-700"}`}>
          {reviewStatus === "teacher_modified" ? "老师已修改" : "默认正确"}
        </span>
      </div>
        ...
        {isEditing ? (
          <div className="space-y-3 rounded-md border border-blue-200 bg-blue-50 p-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button className="inline-flex items-center justify-center gap-2 rounded-md bg-blue-600 px-3 py-2 font-medium text-white hover:bg-blue-700" onClick={confirmEdit}>
                <Check className="h-4 w-4" />
                确认修改
              </button>
              <button className="inline-flex items-center justify-center gap-2 rounded-md border border-neutral-300 bg-white px-3 py-2 font-medium hover:bg-neutral-50" onClick={cancelEdit}>
                <X className="h-4 w-4" />
                取消
              </button>
            </div>
          ...
          <button className="inline-flex w-full items-center justify-center gap-2 rounded-md border border-neutral-300 px-4 py-3 font-medium hover:bg-neutral-50" onClick={startEditing}>
